...
//  FoodDeliveryApp
//
//  Created by Vova Lincore on 26.04.2024.
//
...
class HomeViewController: UIViewController {
    ...
    private let geoMarkImageView = UIImageView()
...
extension HomeViewController {
    ...
    func configureGeoMark() {
        contentView.addSubview(geoMarkImageView)
        
        geoMarkImageView.image = UIImage(resource: .geoMark)
        geoMarkImageView.translatesAutoresizingMaskIntoConstraints = false
        
        NSLayoutConstraint.activate([
            geoMarkImageView.heightAnchor.constraint(equalToConstant: 20),
            geoMarkImageView.widthAnchor.constraint(equalToConstant: 14),
            geoMarkImageView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 30),
            geoMarkImageView.topAnchor.constraint(equalTo: searchField.bottomAnchor, constant: 10),
        ])
    }
    func configureGeoLabel() {
        ...
        NSLayoutConstraint.activate([
            geoLabel.centerYAnchor.constraint(equalTo: geoMarkImageView.centerYAnchor, constant: 0),
            geoLabel.leftAnchor.constraint(equalTo: geoMarkImageView.rightAnchor, constant: 10),
    ...
    func setupSmallHCollection() {
        ...
        NSLayoutConstraint.activate([
            smallHCollection.topAnchor.constraint(equalTo: geoMarkImageView.bottomAnchor, constant: 30),
